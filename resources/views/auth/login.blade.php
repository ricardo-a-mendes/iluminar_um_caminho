...
@section('container')
    ...
    <br>
    <div class="ui grid">
        <div class="sixteen column computer tablet only row">
    ...
    <div class="ui grid">
        <div class="sixteen column mobile only row">
            <div class="column"></div>
            <div class="ten wide column">

                <div class="ui blue message attached">
                    <div class="header">
                        Bem vindo ao<br>Projeto Iluminar um Caminho!
                    </div>
                    <p>Você pode fazer login com sua conta ou utilizar seu Facebook</p>
                </div>
                <div class="ui placeholder attached segment showLoading">
                    ...
                    <form class="ui form" method="POST" action="{{ route('login') }}">
                        @csrf
                        <div class="field">
                            <label class="ui left aligned">e-mail</label>
                            <div class="ui left icon input">
                                <input type="email" name="email" placeholder="email">
                                <i class="user icon"></i>
                            </div>
                        ...
                        <div class="field">
                            <a class="ui button addLoading" href="{{ route('register') }}">
                                <i class="signup icon"></i>
                                Registrar
                            </a>
                        </div>
